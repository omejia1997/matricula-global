...
public interface CalificacionRepository extends JpaRepository<Calificacion, CalificacionPK> {
    List<Calificacion> findByPkCodPersonaAndCodPeriodoOrderByPkCodNrc (Integer codPersona, Integer codPeriodo);
    List<Calificacion> findByPkCodPersonaAndPkCodNrc (Integer codPersona, Integer codNrc);
}
