...
public interface InstitucionGeneralRepository extends JpaRepository<InstitucionGeneral,String>{
    ...
    List<InstitucionGeneral> findByNombreComercialLikeOrderByNombreComercial(String nombreComercial);
    List<InstitucionGeneral> findByRazonSocialLikeOrderByRazonSocial(String razonSocial);
}
