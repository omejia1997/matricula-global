...
public class Calificacion implements Serializable {
    ...
    @Column(name = "cod_periodo", nullable = false, length = 8)
    private Integer codPeriodo;
    @Column(name = "cod_departamento", nullable = false, length = 8)
    private Integer codDepartamento;
    @Column(name = "cod_materia", nullable = false, length = 8)
    ...
    public Calificacion(CalificacionPK pk) {
        this.pk = pk;
    }
    ...
    public void setcalificacionPK(CalificacionPK pk) {
        this.pk = pk;
    }
