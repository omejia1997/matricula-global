...
public interface UbicacionGeograficaRepository extends JpaRepository<UbicacionGeografica,String>{
    List<UbicacionGeografica> findByCodPaisAndNivel(String codPais, Integer Nivel);
    List<UbicacionGeografica> findByCodUbicacionGeoPadre(Integer codUbicacionGeoPadre);
}
